...
if [ $dvar -gt 0 ]
then
wget -O /root/10k.tgz https://raw.githubusercontent.com/TechD-git/watsonDemos/main/demos/watson/10k.tgz
tar -xvzf /root/10k.tgz -C /root
else
mkdir /root/10k
wget -O /root/da/sec.js https://raw.githubusercontent.com/TechD-git/watsonDemos/main/dataAggregator/sec.js
(node /root/da/sec.js "$(< /root/secData.txt)"  > /var/log/secData.log 2>&1 ) &
fi

wget -O /root/.node-red/flows_$(< /root/resourceGroup.txt)-vsi.json https://raw.githubusercontent.com/TechD-git/watsonDemos/main/demos/watson/flowsV2.json
wget -O /root/discovery.tgz https://raw.githubusercontent.com/TechD-git/watsonDemos/main/demos/watson/discoV2.tgz
wget -O /root/finance_dte_model.zip https://ibm.box.com/shared/static/h7sca2gyrz0az58vicqlqijh1mvtl71u.zip

wget -O /root/upsell.zip https://raw.githubusercontent.com/TechD-git/watsonDemos/main/demos/watson/upsell.zip
